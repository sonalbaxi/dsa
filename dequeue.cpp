...
void dqueue::del()
{
    ...
    {
        cout<<endl;
        cout<<"1.for Delete Element at first"<<endl;
        cout<<"2.for Delete Element at last"<<endl;
...
void dqueue::display()
{
    ...
    {
        cout<<endl;
        cout<<"1. for Display Deque from Beginning"<<endl;
        cout<<"2. for Display Deque from End"<<endl;
        cout<<"3. for Exit"<<endl;
        cout<<endl;
        cout<<"Enter Your Choice: ";
        cin>>ch;
